...
void interrupt liaison_serie(void)
{
    if (RCIF==1)                // identification de la source IT = reception
    {
        ...
        if(car=='e' || car=='a' || car=='u' || car=='o' || car=='n' || car=='0' || car=='6' || car=='7' || car=='8' || car=='9' || car=='|'){
            ...
            if(compare( &reception, "eau60")){                // fonctions pour controler les modes
                bouilloire_mode(1);
                COM_Puts("ok60|");                            // reponse
                i=10;
                ...
                COM_Puts("ok90|");
                i=10;
            }else if(compare( &reception, "eauon")){            // allumage de la bouilloire
                COM_Puts("okon|");
                RA4=0;
                __delay_ms(100);
                RA4=1;
...
void bouilloire_mode(char val){             // simulation du bouton de gestion de la temperature
